    ...
    <section id="testimonials" className="py-20 md:py-32 bg-white relative overflow-hidden">
      <div className="container mx-auto px-6 relative z-10" ref={ref}>
        ...
        >
          ...
          {/* Quote */}
          <blockquote className="text-3xl md:text-4xl font-bold text-slate-950 mb-8 leading-snug tracking-tight">
          ...
          <p className="text-slate-600 text-xl font-medium">
            — Sarah M., <span className="text-blue-600 font-semibold">London</span>
          </p>
        </motion.div>
      </div>
    </section>
